  ...
  return (
    <div className="w-full bg-white rounded-lg p-4 border">
      <h1 className="text-black text-xl font-bold mb-4">
        Catatan <span className="text-slate-500 font-semibold">(Pilihan)</span>
      </h1>
      <div className="flex flex-col gap-1">
        <ValidatedTextarea error={errors.notes} register={register} name="notes" id="notes" placeholder="" />
