    ...
    return (
        <div>
            ...
            <button
                ...
                className="flex items-center justify-between rounded-lg p-2 bg-cyan bg-opacity-10 border border-cyan text-white px-5 py-3 w-full"
            >
                <div className="flex items-center">
                    <FaMoneyCheckDollar fontSize={15} className="text-cyan text-3xl mr-2" />
