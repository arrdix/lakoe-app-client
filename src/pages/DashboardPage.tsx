        ...
        <div>
            <div className="w-full h-full p-5 0">
                <div className=" flex justify-between gap-2.5 ">
                    <h1 className="text-9xl">CHART</h1>
                    ...
                    <div className="w-full h-full bg-white w-60 h-28">
                        <div className="p-3">
                            ...
                            <div className="flex justify-between">
                                ...
                                <Link className="text-blue-500 " style={{ fontSize: '12px' }} to="">
                                    Lihat semua
                                </Link>
                            </div>
                            <div className="font-bold text-xl">Rp0</div>
                ...
                <div className=" w-full  bg-white mt-5 p-4 ">
                    ...
                    <div className="flex">
                        <DashboardBox
                            text="Penarikan Selesai"
                            value={0}
                            icon={<SquareCheckBig size={'2rem'} />}
                        />
                        <DashboardBox
                            text="Pendapatan COD"
                            value={0}
                        ...
                        />
                        <DashboardBox
                            text="CashBack Pengiriman"
                            value={0}
                            icon={<HiCash size={'2rem'} />}
                        />
                        <DashboardBox
                            text="Pendapatan E-Payment"
                            value={0}
                            icon={<SiContactlesspayment size={'3rem'} />}
                        />
                    </div>

                    <div className="flex">
                        <DashboardBox
                            text="Refund Biaya Pengiriman"
                            value={0}
                            icon={<FaMoneyBillTransfer size={'2rem'} />}
                        />
                        <DashboardBox
                            text="Kredit Lainnya"
                            value={0}
                            icon={<CiCreditCard2 size={'2rem'} />}
                        />
                        <DashboardBox
                            text="Klaim Pengiriman "
                            value={0}
                            icon={<FaMapLocationDot size={'2rem'} />}
                        />
                        <DashboardBox
                            text="Pembayaran Penagihan"
                            value={0}
                            icon={<HandCoins size={'2rem'} />}
                        />
                    </div>
                </div>
                            ...
                            <DropdownMenu>
                                <DropdownMenuTrigger className="flex">
                                    ...
                                    <Button className=" bg-white text-black rounded-none  ">
                                        {' '}
                                        <HiOutlineDownload size={'1.5rem'} /> Eksport{' '}
                                        <IoMdArrowDropdown />
                                    </Button>
                                </DropdownMenuTrigger>
                                <DropdownMenuContent>
